...
(function () {
  d3.timeline = function() {
      ...
      g.each(function(d, i) {
        d.forEach( function(datum, index){
          ...
          function getStackPosition(d, i) {
            if (stacked) {
              return margin.top + 15 + (itemHeight + itemMargin) * yAxisMapping[index];
            }
            return margin.top;
          }
          function getStackTextPosition(d, i) {
            if (stacked) {
              return margin.top + 15 + (itemHeight + itemMargin) * yAxisMapping[index] + itemHeight * 0.75;
            }
            return margin.top + 15 + itemHeight * 0.75;
          }
        });
      });
    ...
    timeline.textColor = function(h) {
      if (!arguments.length) return textColor;
      textColor = h;
      return timeline;
    }

    timeline.barOpacity = function(h) {
